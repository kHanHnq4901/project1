    ...
    if (isset($_GET["ma"])) {
        ...
        <body>
            ...
            <div class="main">
                ...
                <div class="form">
                    <form action="chinh-sua-admin-process.php">
                        <center>
                            <h2>Chỉnh sửa thông tin tài khoản <?php echo $tt["user"] ?></h2>
                        </center>
                        <input type="hidden" name="ma" value="<?php echo $ma ?>">
                        <table class="chinh-sua">
                            <tr>
                                <td>Họ và tên : </td>
                                <td> <input type="text" name="ten" value="<?php echo $tt["tenAdmin"] ?>"></td>
                            </tr>
                            <tr>
                                <td>Ngày sinh :</td>
...
<?php  } else header("Location:quan-ly-admin.php");
